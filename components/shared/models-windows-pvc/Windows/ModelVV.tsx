const ModelVV = ({ width, height }: { width: number; height: number }) => {
  return (
    <div className="flex items-center justify-center w-full h-full bg-white border border-gray-300 print:h-52 print:w-52">
      <div className="flex items-center justify-center bg-white border border-gray-300 w-[42%] h-[90%]">
        <div className="grid grid-cols-2 border border-gray-300 bg-gradient-to-t from-cyan-200 to-cyan-100 w-[80%] h-[86%]">
      ...
      <div className="flex items-center justify-center bg-white border border-gray-300 w-[42%] h-[90%]">
        <div className="grid grid-cols-2 border border-gray-300 bg-gradient-to-t from-cyan-200 to-cyan-100  w-[80%] h-[86%] "></div>
      </div>
    </div>
  );
};
