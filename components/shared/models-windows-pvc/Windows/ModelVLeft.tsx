const ModelVLeft = ({ width, height }: { width: number; height: number }) => {
  return (
    <div className="flex items-center justify-center w-1/2 h-full bg-white border border-gray-300 print:h-52 print:w-52">
      <div className="flex items-center justify-center bg-white border border-gray-300 h-[90%] w-[80%]">
