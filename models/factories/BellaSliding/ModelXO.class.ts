...
export class BellaSlidingModelXO implements IModelXO {
  ...
  public setVerticalTransom(baseWindow: WindowPVC, model: WindowModel) {
    if (model.profile_sash) {
      ...
      this.windowCost.transomCost += baseWindow.heightMeters * model.profile_sash.price;
      this.windowCost.transomCost += baseWindow.heightMeters * model.profile_sash.reinforcement_profile.price;
      // Screws
